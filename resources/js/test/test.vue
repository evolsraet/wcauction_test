<template>
    <div class="container pt-5">
        <!-- 회원가입 권장 섹션 -->
        <div class="py-3 mt-5 app-specific-size">
                    ...
                    <form @submit.prevent="submitLogin">
                        <div class="">
                            <div class="my-3 text-left">
                                <p class="text-muted ms-2">이미 위카 회원이신가요?</p>
                            </div>
                            <!-- 이메일 입력 -->
                            <div class="mb-3">
...
<style>
    ...
    .car-imges {
        width: 100%;
        height: 126px;
        background-image: url('/resources/img/car.png');
    ...
    .filled-star {
        background-image: url('/resources/img/filled_star.png');
    }

    .empty-star {
        background-image: url('/resources/img/emp_star.png');
    }
